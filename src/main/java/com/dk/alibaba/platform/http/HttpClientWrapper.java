...
public class HttpClientWrapper {
    ...
    public static final Header[] JSON_HEADERS = {
            new BasicHeader("Content-Type", "applicatin/json;charset=UTF-8"),
            new BasicHeader("Accept", "applicatin/json"),
    ...
    public HttpClientWrapper() {
        ...
        sslsf = new SSLConnectionSocketFactory(ctx, SSLConnectionSocketFactory.ALLOW_ALL_HOSTNAME_VERIFIER);
     ...
     */
    public HttpClientWrapper(String type, String certFilePath, String certPassword) {
    ...
    public String get(String url) throws IOException {
        HttpResponse httpResponse = get(url, null, null, null, null);
        String s = EntityUtils.toString(httpResponse.getEntity(), Consts.UTF_8);
        return s;
    }
    ...
    public String upload(String url, String name, File file, Header[] headers) {
        HashMap<String, File> stringFileHashMap = CollectionUtil.newHashMap();
